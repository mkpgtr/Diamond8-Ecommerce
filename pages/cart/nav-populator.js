              ...
              <ul class="navbar-nav justify-content-around flex-wrap w-100">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="../product-categories/women/women.html">All</a></li>
                    <li><a class="dropdown-item" href="../product-categories/women/women-dresses.html">Dresses</a></li>
                    <li><a class="dropdown-item" href="../product-categories/women/women-pants.html">Pants</a></li>
                    <li><a class="dropdown-item" href="../product-categories/women/women-skirts.html">Skirts</a></li>
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="../product-categories/men/men.html">All</a></li>
                    <li><a class="dropdown-item" href= "../product-categories/men/men-hoodies.html">Hoodies</a></li>
                    <li><a class="dropdown-item" href="../product-categories/men/men-pants.html">Pants</a></li>
                    <li><a class="dropdown-item" href="../product-categories/men/men-shirts.html">Shirts</a></li>
                  </ul>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="../product-categories/kids/kids.html">Kids</a>
                </li>
                <li class="nav-item">
...
<div class="row flex-column align-items-center flex-md-row flex-lg-row">
        ...
        <div class="col-12 col-md-6 col-lg-3 d-flex justify-content-center">
          <div class="footer-women card w-100">
            ...
            <a href='../product-categories/women/women.html'><h4 class="footer-heading card-header text-center">Women</h4></a>
              <li class="list-group-item"><a href="../product-categories/women/women-dresses.html">Dresses</a></li>
              <li class="list-group-item"><a href="../product-categories/women/women-pants.html">Pants</a></li>
              <li class="list-group-item"><a href="../product-categories/women/women-skirts.html">Skirts</a></li>
        ...
        <div class="col-12 col-md-6 col-lg-3 d-flex justify-content-center">
          ...
          <ul class="list-group list-group-flush text-center">
          <a href="../product-categories/men/men.html"><h4 class="footer-heading card-header text-center">Men</h4></a>
            <li class="list-group-item"><a href="../product-categories/men/men-hoodies.html">Hoodies</a></li>
            <li class="list-group-item"><a href="../product-categories/men/men-hoodies.html">Pants</a></li>
            <li class="list-group-item"><a href="../product-categories/men/men-hoodies.html">Shirts</a></li>
            </ul>
          </div>
        </div>
        <div class="col-12 col-md-6 col-lg-3 d-flex justify-content-center">
        ...
        <ul class="list-group list-group-flush text-center">
        <a href='../product-categories/kids/kids.html'><h4 class="footer-heading card-header text-center">Kids</h4></a>
