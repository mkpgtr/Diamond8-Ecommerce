...
<nav class="navbar navbar-expand-md bg-body-tertiary first-nav">
        ...
        <div class="container-fluid">
            ...
            <a class="navbar-brand">Diamond8</a>
              ...
              <ul class="navbar-nav justify-content-around flex-wrap w-100">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="./women-dresses.html">Dresses</a></li>
...
<div class="row flex-column align-items-center flex-md-row flex-lg-row">
        ...
        <div class="col-12 col-md-6 col-lg-3 d-flex justify-content-center">
          <div class="footer-women card w-100">
            ...
            <a href='./women.html'><h4 class="footer-heading card-header text-center">Women</h4></a>
            <li class="list-group-item"><a href='./women-dresses.html'>Dresses</a></li>
            <li class="list-group-item"><a href='./women-pants.html'>Pants</a></li>
            <li class="list-group-item"><a href='./women-skirts.html'>Skirts</a></li>
            </ul>
          </div>
        </div>
        <div class="col-12 col-md-6 col-lg-3 d-flex justify-content-center">
        ...
        <div class="col-12 col-md-6 col-lg-3 d-flex justify-content-center">
          ...
          <ul class="list-group list-group-flush text-center">
          <a href="../kids/kids.html"><h4 class="footer-heading card-header text-center">Kids</h4></a>
